...
(define-key artbollocks-mode-keymap (kbd "C-c M-a e") 'artbollocks-reading-ease)
(define-key artbollocks-mode-keymap (kbd "C-c M-a g") 'artbollocks-grade-level)
(define-key artbollocks-mode-keymap (kbd "C-c M-a r")  'artbollocks-readability-index)
(define-key artbollocks-mode-keymap (kbd "C-c M-a w")  'artbollocks-weasel-count)
